...
namespace Verse {
	...
	public class PlantWithComps : Plant {
        ...
        public IEnumerable<T> GetComps<T>() where T : ThingComp
        {
            ...
            /*
            IEnumerable<T> retval = new IEnumerable<T>();
            foreach( ThingComp tc in this.comps ) {
                T t = tc as T;
                if ( t != null ) {
                    retval.Add(
                    retval
                ...
                return retval;
                PlantWithComps.<GetComps>c__Iterator124<T> <GetComps>c__Iterator = new PlantWithComps.<GetComps>c__Iterator124<T>();
                <GetComps>c__Iterator.<>f__this = this;
                PlantWithComps.<GetComps>c__Iterator124<T> expr_0E = <GetComps>c__Iterator;
                expr_0E.$PC = -2;
                return expr_0E;
            }
            */
        ...
        public override IEnumerable<Gizmo> GetGizmos()
        {
            ...
            //for (int i = 0; i < this.gizmos.Count; i++) { yield return this.gizmos[i]; }
            /*
            PlantWithComps.<GetGizmos>c__Iterator125 <GetGizmos>c__Iterator = new PlantWithComps.<GetGizmos>c__Iterator125();
            <GetGizmos>c__Iterator.<>f__this = this;
            PlantWithComps.<GetGizmos>c__Iterator125 expr_0E = <GetGizmos>c__Iterator;
            expr_0E.$PC = -2;
            return expr_0E;
            */
        }
        ...
        public override IEnumerable<FloatMenuOption> GetFloatMenuOptions(Pawn selPawn)
        {
            ...
            //for (int i = 0; i < this.gizmos.Count; i++) { yield return this.gizmos[i]; }
            /*
            PlantWithComps.<GetFloatMenuOptions>c__Iterator126 <GetFloatMenuOptions>c__Iterator = new PlantWithComps.<GetFloatMenuOptions>c__Iterator126();
            <GetFloatMenuOptions>c__Iterator.selPawn = selPawn;
            <GetFloatMenuOptions>c__Iterator.<$>selPawn = selPawn;
            <GetFloatMenuOptions>c__Iterator.<>f__this = this;
            PlantWithComps.<GetFloatMenuOptions>c__Iterator126 expr_1C = <GetFloatMenuOptions>c__Iterator;
            expr_1C.$PC = -2;
            return expr_1C;
            */
        }
